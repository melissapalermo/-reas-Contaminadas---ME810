...
O banco de dados utilizado nessa análise foi disponibilizado pela CETESB, e contém 832 registros de 2011 a 2016 com informações sobre as áreas com solo contaminado no municipio de Campinas. Para a realização da análise foi conversado com a cliente e selecionado as variáveis que poderiam explicar explicar o número de áreas contaminadas, sendo assim o banco de dados se reduziu em:
nome;rua;	bairro;	atividade;	utm_e;	utm_n;	ano;	classif;	fonte_cont;	Região Central.
 
 Na variável Região Central, consideramos os seguintes bairros como central: Botafogo, Cambuí, Centro, Guanabara, Vila Industrial, Vila Itapura, e como não central os demais.
