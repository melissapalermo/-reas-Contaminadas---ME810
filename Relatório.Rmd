...
maxbairros =  c("BARÃO GERALDO","BOA VISTA", "BONFIM", "CAMBUI", "CENTRO", "DISTRITO INDUSTRIAL", "JARDIM CHAPADÃO", "TAQUARAL", "VILA INDUSTRIAL ") #BAIRROS COM MAIS DE 15 AREAS
...
plot(maxbairros, maybairros) #pq nao da certo???
 boxplot(maybairros~maxbairros)
```
